...
extern DEVMAP_T cei_pMap[MAX_DEVICES];
extern CEI_INT openDevice(CEI_UINT device);
extern CEI_INT closeDevice(CEI_UINT device);
...
#define BTD_BAD_CONF_FILE 29
#define BTD_HASH_ERR 37
