...
#define API_REV    806               /* Release version number */
#define API_VER    "8.06"            /* Release version for the resource file */
#define API_RC_VER 8,0,6,0           /* Release version for the resource file */
#define API_TYPE "Release 10/25/2012" /* Release type is BETA or RELEASE   */
#define API_MISC "RAR15-XMC-XT and V6 support"
#define API_PRODUCTS "R15-USB RAR15-XMC-XT/RXMC/RQVME2/R15-AMC/RPCIe-1553/R15-EC/QPCI/QPCX/QPMC/QPM/QVME/Q014/QcP-1553 IP-D1553 PCCard-D1553" 
#define API_FIRMWARE "6.01/5.18/4.66/4.46/4.40"
#define API_OS_SUPPORT "64-Bit & 32-Bit Windows, Linux, Solaris, VxWorks, Integrity, QNX, LynxOS "
...
#define RAR15XMC    0x340    /* This is the RAR15XMC multi-protocol XMC   */
...
#define FPGA      1     // for the external FPGA temp sensor
#define ZBT       2     // for the external ZBT temp sensor
#define CH4_1553  3	   // for the external 1553 Ch4 temp sensor
#define MID_BOARD 4    // for the external mid-board primary thermal interface temp sensor
...
#define MFO_INTR_ENBL    0x0080  // Minor Frame Overflow Interrupt Enable
...
typedef struct bt1553_time64
   {
   BT_U32BIT  nanoseconds PACKED;   // nanoseconds since start
   BT_U32BIT  topnseconds PACKED;   // Most significant part of nanoseconds
   }
BT1553_TIME64;
...
typedef struct device_info
{
   ...
   unsigned int   CSCReg;                     // the CSC register
}DEVICE_INFO;
...
#define EVENT_EXT_TRIG       0x0001  /* interrupt on external trigger input    */
...
#define EVENT_LP_MF_OVFL    0x20000
#define EVENT_HP_MF_OVFL    0x40000
#define EVENT_BC_BSY_OVFL   0x80000
...
NOMANGLE BT_INT CCONV BusTools_V6_SetDiscreteOut(
   ...
   BT_UINT disValue);          // (i) discrete value 0-ground 1-pull-up to 3.3v or for input
...
#define API_BUSTOOLS_DWORD_SIZE  224   // CEI-WARN -- DWORD byte count must be mulitple of 4.
