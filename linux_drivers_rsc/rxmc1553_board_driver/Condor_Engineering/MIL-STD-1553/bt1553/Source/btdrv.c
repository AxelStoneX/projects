   ...
   BT_UINT   HWflag)        // (i) hw/sw flag: 0->sw, 1->hw, 2->HW interrupt enable
{
   ...
   *******************************************************************/
   ...
   lpAPI_BM_Buffers[cardnum] = CEI_MALLOC(NAPI_BM_V6BUFFERS[cardnum] * sizeof(API_BM_MBUF));
   ...
   BT_UINT   wordsToRead)   // (i) number of WORDS to copy
{
   ...
   *******************************************************************/
   ...
   for ( i = 0; i < wordsToRead; i++ )
   {
      lpbuffer[i] = fliplongs(((BT_U32BIT *)(bt_PageAddr[cardnum][RAM_PAGE]+byteOffset))[i]);
   }
}
   ...
   BT_UINT   wordsToRead)   // (i) number of WORDS to copy
{
   ...
   *******************************************************************/
   ...
   for ( i = 0; i < wordsToRead; i++ )
   {
      lpbuffer[i] = fliplongs(((BT_U32BIT *)(bt_PageAddr[cardnum][SHR_MEM_PAGE]+byteOffset))[i]);
   }
}
   ...
   BT_UINT   wordsToRead)   // (i) number of WORDS to copy
{
   ...
   *******************************************************************/
   ...
   for ( i = 0; i < wordsToRead; i++ )
   {
      lpbuffer[i] = fliplongs(((BT_U32BIT *)(bt_PageAddr[cardnum][BASE_PAGE]+byteOffset))[i]);
   }
   ...
   BT_UINT   wordToWrite) // (i) number of bytes to copy
{
   ...
   *******************************************************************/
   ...
   {
      ((BT_U16BIT *)(bt_PageAddr[cardnum][RAM_PAGE]+byteOffset))[i] = flipws(lpbuffer[i]);
   }
}
   ...
   BT_UINT   wordsToWrite) // (i) number of bytes to copy
{
   ...
   *******************************************************************/
   ...
   for ( i = 0; i < wordsToWrite; i++ )
   {
      ((BT_U32BIT *)(bt_PageAddr[cardnum][SHR_MEM_PAGE]+byteOffset))[i] = fliplongs(lpbuffer[i]);
   }
}
   ...
   BT_UINT   wordsToWrite) // (i) number of bytes to copy
{
   ...
   *******************************************************************/
   ...
   for ( i = 0; i < wordsToWrite; i++ )
   {
      ((BT_U32BIT *)(bt_PageAddr[cardnum][RAM_PAGE]+byteOffset))[i] = fliplongs(lpbuffer[i]);
   }
}
   ...
   BT_UINT   wordToWrite) // (i) number of bytes to copy
{
   ...
   *******************************************************************/
   ...
   for ( i = 0; i < wordToWrite; i++ )
   {
      ((BT_U16BIT *)(bt_PageAddr[cardnum][BASE_PAGE]+byteOffset))[i] = flipws(lpbuffer[i]);
   }
}
   ...
   BT_UINT   wordsToWrite) // (i) number of bytes to copy
{
   ...
   *******************************************************************/
   ...
   for ( i = 0; i < wordsToWrite; i++ )
   {
      ((BT_U32BIT *)(bt_PageAddr[cardnum][BASE_PAGE]+byteOffset))[i] = fliplongs(lpbuffer[i]);
   }
}
   ...
   BT_U16BIT frame)
{
   ...
   if ( (CurrentCardType[cardnum] == Q1041553) || (CurrentCardType[cardnum] == PCCD1553) ) 
   ...
   BT_U16BIT frame)         // (i) actual value to load into frame register
{
   ...
   *******************************************************************/
   ...
   if ( CurrentCardType[cardnum] == Q1041553 || CurrentCardType[cardnum] == PCCD1553 )  // Single- or multi-function
   {   // Q104-1553 ISA.  The fourth page pointer maps the Hardware Interface Regs.
       // The frame register is one of these registers.
       if ( CurrentCardSlot[cardnum] == CHANNEL_1 )
       {
