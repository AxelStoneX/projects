...
static char *version = "uceiisa.c:v2.03 - (12/06/2011) Brian Hill(support.avionics.ip@ge.com)\n";
...
MODULE_DESCRIPTION("Condor Engineering Universal Linux kernel 2.4 ISA device driver.  Do not distribute the source code.");
