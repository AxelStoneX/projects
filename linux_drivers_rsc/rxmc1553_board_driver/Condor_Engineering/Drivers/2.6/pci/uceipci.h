...
static char* uceipci_version="v1.20 - (08/07/2012) Brian Hill(support.avionics.ip@ge.com)";
...
MODULE_DESCRIPTION("GE Intelligent Platforms avionics universal Linux kernel 2.6 PCI device driver v1.20.  Do not distribute the source code.");
