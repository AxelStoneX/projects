...
MODULE_DESCRIPTION("GE Intelligent Platforms avionics Linux kernel 2.6 PCMCIA device driver.  Do not distribute the source code.");
...
static char *version="cei_pcc1553_cs:v1.02 - (11/18/2008) Brian Hill(support.avionics.ip@ge.com)";
