 ...
 *===========================================================================*
 *
 * FUNCTION:   GE Intelligent Platforms universal ISA device driver (hybrid)
 *
 *             This module provides the interface between GE Intelligent
 *             Platforms avionic ISA products and the Linux kernel 2.6.x. 
 *             It performs the necessary functions (registering, memory
 *             mapping,..) needed to operate in a LINUX operating system.
 *             This module is utilized by multiple GE Intelligent Platforms
 *             avionic products, use care when performing modifications.
 * 
 *
