...
static char *version="v1.10 - (11/03/2011) Brian Hill(support.avionics.ip@ge.com)\n";
...
MODULE_DESCRIPTION("GE Intelligent Platforms avionics universal Linux kernel 2.6 ISA device driver v1.10.  Do not distribute the source code.");
