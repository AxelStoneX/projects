 ...
 *             Platforms avionics PCI products and the Linux kernel 3.x.x.  It
...
static int __init uceipci_init_module(void) {
  ...
  if(kv1 != 3)
    ...
    if((kv2 == 0) && (kv3 > 47)) status = 1;
    else if((kv2 == 1) && (kv3 > 10)) status = 1;
    else if((kv2 == 2) && (kv3 > 32)) status = 1;
    else if((kv2 == 3) && (kv3 >  8)) status = 1;
    else if((kv2 == 4) && (kv3 > 15)) status = 1;
    else if((kv2 == 5) && (kv3 >  7)) status = 1;
    else if((kv2 == 6) && (kv3 >  3)) status = 1;
  }
  if(status == 1) 
