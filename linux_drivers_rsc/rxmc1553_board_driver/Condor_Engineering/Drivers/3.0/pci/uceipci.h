...
static char* uceipci_version="v1.01 - (10/09/2012) Brian Hill(support.avionics.ip@ge.com)";
...
MODULE_DESCRIPTION("GE Intelligent Platforms avionics universal Linux kernel 3.x PCI device driver v1.01.  Do not distribute the source code.");
